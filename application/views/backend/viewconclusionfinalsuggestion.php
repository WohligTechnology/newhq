...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.conclusion + "</td><td><a class='btn btn-primary btn-xs waves-effect waves-light blue darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/editconclusionfinalsuggestion?id=');?>"+resultrow.id+"'><i class='material-icons'>mode_edit</i></a><a class='btn btn-danger btn-xs waves-effect waves-light red pad10 z-depth-0 less-pad' onclick=\"return confirm('Are you sure you want to delete?');\" href='<?php echo site_url('site/deleteconclusionfinalsuggestion?id='); ?>"+resultrow.id+"'><i class='material-icons propericon'>delete</i></a><a class='btn btn-primary btn-xs waves-effect waves-light blue pad10 darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/viewsurveyquestionuser?id='); ?>"+resultrow.id+"'><i class='material-icons propericon'>supervisor_account</i></a><a class='btn btn-primary btn-xs waves-effect waves-light blue pad10 darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/viewsurveyquestionuser?id='); ?>"+resultrow.id+"'><i class='material-icons propericon'>loop</i></a></td></tr>";
}
