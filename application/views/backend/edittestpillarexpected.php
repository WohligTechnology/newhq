<div class="row">
    <div class="col s12">
        <h4 class="pad-left-15">Edit Test Pillar Expected</h4>
    </div>
    <form class="col s12" method="post" action="<?php echo site_url('site/edittestpillarexpectedsubmit');?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="input-field col s12 m6">
                ...
                <input type="text" id="expectedvalue" name="expectedvalue" value="<?php echo set_value('expectedvalue',$before->expectedvalue);?>">
            </div>
        </div>
        <div class="row">
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edittestpillarexpectedsubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="normal-field" class="form-control" name="expectedvalue" value='<?php echo set_value(' expectedvalue ',$before->expectedvalue);?>'>
                            </div>
                        </div>
