...
<input type="text" id="Start Time" name="starttime" value='<?php echo set_value('starttime',$before->starttime);?>'>
</div>
</div>
<div class="row">
<div class="input-field col s6">
<label for="End Time">End Time</label>
<input type="text" id="End Time" name="endtime" value='<?php echo set_value('endtime',$before->endtime);?>'>
</div>
</div>
<div class="row">
<div class="col s6">
