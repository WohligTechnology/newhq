<div class="row">
    <div class="col s12"><div class="row">
            ...
            <div class="col s12 drawchintantable">
               <?php $this->chintantable->createsearch(' Test');?>
