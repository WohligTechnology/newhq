...
<a class="waves-effect waves-light btn pleft waves-effect waves-light btn blue darken-4" href="<?php echo base_url('uploads/surveydemosheet.csv');?>"><i class='material-icons propericon' style="
    margin-right: 5px;
       	...
       	<div class="row">
			<div class="file-field input-field col m6 s12">
				<div class="btn blue darken-4">
					<span>Survey User CSV File</span>
