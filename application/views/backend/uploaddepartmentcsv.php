...
<a class="waves-effect waves-light btn pleft waves-effect waves-light btn blue darken-4" href="<?php echo base_url('uploads/department.csv');?>"><i class='material-icons propericon' style="
    margin-right: 5px;
