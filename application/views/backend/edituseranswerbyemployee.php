    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edituseranswerbyemployeesubmit");?>' enctype='multipart/form-data'>
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    <?php echo form_dropdown( "user",$user,set_value( 'user',$userid),"class='chzn-select form-control'");?>
                </div>
            </div>
            <div class=" form-group">
                <label class="col-sm-2 control-label" for="normal-field">Pillar</label>
                <div class="col-sm-4">
                    <?php echo form_dropdown( "pillar",$pillar,set_value( 'pillar',$questiondata->pillar),"id='pillarid' class='pillar chzn-select form-control'");?>
                </div>
            </div>
            <div class=" form-group">
                <label class="col-sm-2 control-label" for="normal-field">Test</label>
                <div class="col-sm-4">
                    <?php echo form_dropdown( "test",$test,set_value( 'test',$testdata->id)," id='testid' class='test chzn-select form-control'");?>
                </div>
            </div>
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    <?php echo form_dropdown( "question",$question,set_value( 'question',$questiondata->id),"id='questionid' class='question chzn-select form-control'");?>
                </div>
            </div>
            <div class=" form-group">
