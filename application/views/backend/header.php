...
<title><?php echo getconfig("hq");?> | <?php echo $title; ?></title>
...
<!--    <script src="<?php echo base_url('assets/js/highcharts-export-outside.js'); ?>"></script>-->
<script>
...
<section id="container" class="">
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo"> <span><b><u>HQ</u></b></span></a>
            <!--logo end-->
            <div class="top-nav ">
