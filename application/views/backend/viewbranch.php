<div class="row">
    <div class="col s12">
        <div class="row">
            <div class="col s12 drawchintantable">
                <?php $this->chintantable->createsearch("List of Branch");?>
                <div class="col s4">
    ...
    <a class="waves-effect waves-light btn blue darken-4" href="<?php echo site_url('site/uploadbranchcsv'); ?>"><i class="icon-trash"></i>Upload CSV</a> &nbsp;
